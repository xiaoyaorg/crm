		...
		$("#myDetailInfo").click(function () {
			...
			$.ajax({
				...
				success:function (data) {
					let htmlStr="";
					htmlStr+="<div style=\"position: relative; left: 40px;\">"
					htmlStr+="姓名：<b>"+data.name+"</b><br><br>"
					htmlStr+="登录帐号：<b>"+data.loginAct+"</b><br><br>"
					htmlStr+="组织机构：<b>"+data.deptno+"</b><br><br>"
					htmlStr+="邮箱：<b>"+data.email+"</b><br><br>"
					htmlStr+="失效时间：<b>"+data.expireTime+"</b><br><br>"
					htmlStr+="</div>"
					$("#divBody").html(htmlStr);
				}
			});
		})
		...
		<div class="modal-dialog" role="document" style="width: 70%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" id="saveEdit">更新</button>
				</div>
			</div>
		</div>
	</div>
			...
			<ul>
				<li class="dropdown user-dropdown">
					...
					<ul class="dropdown-menu">
						<li><a href="javascript:void(0)" id="myDetailInfo"><span class="glyphicon glyphicon-file"></span> 我的资料</a></li>
			...
			<ul id="no1" class="nav nav-pills nav-stacked">
				...
				<li class="liClass">
					...
					<ul id="no2" class="nav nav-pills nav-stacked collapse">
						<%--<li class="liClass"><a href="workbench/chart/activity/index1.do" target="workareaFrame">&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-chevron-right"></span> 市场活动统计图表</a></li>
